...
def load_from(sam, state_dict, image_size, vit_patch_size):
    ...
    if pos_embed.shape[1] != token_size:
        ...
        pos_embed = F.interpolate(pos_embed, (token_size, token_size), mode='bilinear', align_corners=False)        # [1, 768, 32, 32]
        pos_embed = pos_embed.permute(0, 2, 3, 1)  # [b, h, w, c]                                                   # [1, 32, 32, 768]
